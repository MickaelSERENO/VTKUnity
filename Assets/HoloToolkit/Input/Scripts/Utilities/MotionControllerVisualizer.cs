...
namespace HoloToolkit.Unity.InputModule
{
    ...
    public class MotionControllerVisualizer : Singleton<MotionControllerVisualizer>
    {
        ...
        public Dictionary<string, MotionControllerInfo> controllerDictionary = new Dictionary<string, MotionControllerInfo>(0);
        ...
        private void UpdateControllerState(bool createNewControllerIfNeeded = true)
        {
            ...
            foreach (var sourceState in InteractionManager.GetCurrentReading())
            {
                ...
                if (controllerDictionary.TryGetValue(key, out currentController))
                {
                    ...
                    //Debug.Log("up_in=" + currentController.ControllerParent.transform.up);
                    //Debug.DrawRay(currentController.ControllerParent.transform.position, currentController.ControllerParent.transform.up, Color.cyan);
                }
            }
#endif
        }
